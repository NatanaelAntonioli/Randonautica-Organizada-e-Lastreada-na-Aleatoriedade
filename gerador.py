    ...
    # plt.clf()  # <MATPLOTLIB>
        ...
        if visitou == 1:
            ...
            if MENU_principal == 2:
                ...
                print("privada for publicada. Quando terminar de jogar nessa seção, execute o fragmento abaixo para ")
                print("baixar todos os arquivos gerados. Eles não possuem qualquer informação que permita identificá-lo,")
